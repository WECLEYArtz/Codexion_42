...
/*   Updated: 2026/07/13 20:28:09 by ahmounsi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	wait_coder_burnout(t_coder *target_coder, t_timeadd *timeoutadd)
{
	int				old_compiles;
	int				rc;
...
void	*monitor(void *t_sim_p)
{
	...
	sim_stop();
	join_coders(monitor, sim->init_records.c_thread_init_ok);
	return (NULL);
}
